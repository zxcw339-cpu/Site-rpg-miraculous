...
O código desta atualização deve ser enviado à branch `main`. O GitHub Actions executa os testes, compila e publica o site; não envie `dist` manualmente. Aguarde a execução verde em [Actions](https://github.com/zxcw339-cpu/Site-rpg-miraculous/actions) antes de testar o site público.
